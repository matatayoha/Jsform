...
class Email(unittest.TestCase):
    ...
    def setUp(self):
        ...
        sleep(1)
        self.driver.find_element_by_id('em').click()
    ...
    def test2(self):
        '''字段长度'''
        SettingOptUtils.element_format(self.driver, 'pfldsize')
        BasicAction.preview(self.driver)
    ...
    def test7(self):
        '''默认值'''
        SettingOptUtils.defval_text(self.driver, 'defval_text', '123@123.com')
        BasicAction.preview(self.driver)
        self.assertEqual(self.driver.find_element_by_xpath('//*[@id="fields"]/li').get_attribute('def'),'123@123.com','默认值设置失败')
    ...
    def test11(self):
        ...
        self.driver.find_element_by_xpath('//*[@id="fields"]/li/div/input').send_keys('123@123.com')
        self.driver.find_element_by_id('btnSubmit').click()
        sleep(1)
        self.assertEqual('123@123.com',DataUtils.verify_data(url, self.formid)['F1'],'提交数据失败')
