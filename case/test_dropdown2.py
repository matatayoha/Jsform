...
class Dropdown2(unittest.TestCase):
    '''测试多级下拉'''
    ...
    def setUp(self):
        ...
        sleep(1)
        self.driver.find_element_by_id('dd2').click()
    ...
    def test2(self):
        ...
        BasicAction.preview(self.driver)
        self.assertIn('m', self.driver.find_element_by_xpath('//*[@id="fields"]/li/div/select').get_attribute('class'),'字段长度设置失败')
    ...
    def test8(self):
        ...
        BasicAction.preview(self.driver)
        self.assertIn('男男', self.driver.find_element_by_css_selector('[value="男男"]').get_attribute('items'),'选择项设置失败')

    def test9(self):
        '''提交数据'''
        self.formid = BasicAction.preview(self.driver)
        self.driver.find_element_by_xpath('//*[@id="fields"]/li/div/select').click()
        self.driver.find_element_by_css_selector('[value="选项 1"]').click()
