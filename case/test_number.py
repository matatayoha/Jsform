...
class Nmuber(unittest.TestCase):
    '''测试数字框'''
    ...
    def setUp(self):
        ...
        sleep(1)
        self.driver.find_element_by_id('nb').click()
    ...
    def test7(self):
        '''默认值'''
        SettingOptUtils.defval_text(self.driver, 'defval_number',10)
        BasicAction.preview(self.driver)
        self.assertEqual(str(self.driver.find_element_by_xpath('//*[@id="fields"]/li').get_attribute('def')),'10','默认值设置失败')
    ...
    def test11(self):
        ...
        self.driver.find_element_by_xpath('//*[@id="fields"]/li/div/input').send_keys(1)
        self.driver.find_element_by_id('btnSubmit').click()
        sleep(1)
        self.assertEqual(1.0,DataUtils.verify_data(url, self.formid)['F1'],'提交数据失败')
