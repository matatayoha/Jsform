...
class Map(unittest.TestCase):
    ...
    def setUp(self):
        ...
        sleep(1)
        self.driver.find_element_by_id('mp').click()
    ...
    def test2(self):
        '''禁止手动标注'''
        self.driver.find_element_by_xpath('//*[@id="popt_dismark"]/label').click()
        BasicAction.preview(self.driver)
        self.assertEqual('获取当前位置', self.driver.find_element_by_css_selector('[class="btn getlocation1"]').text,'禁止手动标注设置失败')
    ...
    def test7(self):
        ...
        self.driver.find_element_by_xpath('//*[@id="fields"]/li/div/input').send_keys('软件园')
        self.driver.find_element_by_id('btnSubmit').click()
        sleep(1)
        self.assertEqual('软件园',DataUtils.verify_data(url, self.formid)['F1'],'提交数据失败')
