...
class Html(unittest.TestCase):
    ...
    def setUp(self):
        ...
        sleep(1)
        self.driver.find_element_by_id('ht').click()
    ...
    def test2(self):
        '''HTML内容'''
        SettingOptUtils.wangEditor_txt(self.driver,'html')
        BasicAction.preview(self.driver)
        self.assertEqual('测试', self.driver.find_element_by_css_selector('label + div').text,'HTML内容设置失败')
