...
class Textarea(unittest.TestCase):
    ...
    def setUp(self):
        ...
        sleep(1)
        self.driver.find_element_by_id('pt').click()
    ...
    def test2(self):
        ...
        BasicAction.preview(self.driver)
        self.assertIn('m', self.driver.find_element_by_xpath('//*[@id="fields"]/li/div/textarea').get_attribute('class'),'字段长度设置失败')
    ...
    def test11(self):
        ...
        self.driver.find_element_by_xpath('//*[@id="fields"]/li/div/textarea').send_keys('测试数据')
