...
class Radio(unittest.TestCase):
    ...
    def setUp(self):
        ...
        sleep(1)
        self.driver.find_element_by_id('mc').click()
    ...
    def test4(self):
        ...
        BasicAction.preview(self.driver)
        self.assertTrue(self.driver.find_element_by_css_selector('[class="fld other"]'), '其他值设置失败')
    ...
    def test6(self):
        ...
        BasicAction.preview(self.driver)
        self.assertIn('男',self.driver.find_element_by_xpath('//*[@id="t2"]').get_attribute('value'), '批量设置失败')
        self.assertIn('剩余', self.driver.find_element_by_css_selector('[style="color:#ccc;"]').text, '增减选项设置失败')
    ...
    def test7(self):
        ...
        BasicAction.preview(self.driver)
        self.assertEqual(self.driver.find_element_by_xpath('//*[@id="fields"]/li').get_attribute('random'),'1', '随机设置失败')
    ...
    def test11(self):
        ...
        self.driver.find_element_by_css_selector('[for="t2"]').click()
