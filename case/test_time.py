...
class Time(unittest.TestCase):
    ...
    def setUp(self):
        ...
        sleep(1)
        self.driver.find_element_by_id('ti').click()
    ...
    def test5(self):
        '''默认值'''
        SettingOptUtils.defval_text(self.driver, 'defval_time', '10:10')
        BasicAction.preview(self.driver)
        self.assertEqual(self.driver.find_element_by_xpath('//*[@id="fields"]/li').get_attribute('def'),'10:10','默认值设置失败')
    ...
    def test9(self):
        ...
        self.driver.find_element_by_css_selector('[class="hh input fld"]').click()
        self.driver.find_element_by_xpath('//*[@id="fields"]/li/div/span[1]/select/option[12]').click()
        self.driver.find_element_by_css_selector('[class="mi input fld"]').click()
        self.driver.find_element_by_xpath('//*[@id="fields"]/li/div/span[3]/select/option[12]').click()
        self.driver.find_element_by_id('btnSubmit').click()
        sleep(1)
        self.assertEqual('10:10',DataUtils.verify_data(url, self.formid)['F1'],'提交数据失败')
